...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // 로그인 성공 후 커플 설정 페이지로 이동
    window.location.href = "/couple-setup";
  };
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 shadow-lg sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
          ...
          <div className="mt-6 text-center">
            ...
            <Link
              href="/"
              className="mt-4 inline-flex items-center text-sm text-gray-500 hover:text-blue-600 transition-colors duration-200"
            >
              ← 홈으로 돌아가기
            </Link>
          </div>
